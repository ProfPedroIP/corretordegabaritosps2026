...
if st.button("🚀 Executar Correção dos Gabaritos", type="primary"):
    if not arquivos_pdf:
        ...
        # --- PRÉ-CONTAGEM DE TODAS AS PÁGINAS PARA A BARRA DE PROGRESSO ---
...
st.caption(f"🚀 **Super Perseu** | Instituto Ponte | Gerado em: {agora.strftime('%d/%m/%Y às %H:%M:%S')}")
